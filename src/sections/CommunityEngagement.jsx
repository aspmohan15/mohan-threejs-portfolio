import { CommunityAndEngagement } from '../constants/index.js';

const CommunityEngagement = () => {
  return (
    <section className="c-space my-20">
      <h3 className="head-text">Community Engagement & Professional Development</h3>

      <div className="client-container">
        {CommunityAndEngagement.map((item) => (
